...
#设置采集多少次数据
#collect_num = 0
for collect_num in trange(6,800):
    ...
    if success:
        ...
        for folder_name in ['topdown', 'front', 'root', 'wrist', 'side','fronttop']: 
            folder_path = os.path.join('/data/yuantingyu/tea_box_9_19', folder_name, f'data_{collect_num:03d}') 
    ...
    if contact_points:
        ...
        #设置csv保存的路径
        base_path = f'/data/yuantingyu/tea_box_9_19'
