...
def save_image(sim_tester, j, timestamp_str, vids):
    ...
    folder_suffix = f"data_{j:03d}"
    folder_rgb = 'rgb'
    base_path = '/data/yuantingyu/cube_9_19'
...
for collect_num in trange(0,800):
    ...
    if success:
        ...
        for folder_name in ['topdown', 'front', 'root', 'wrist', 'side','fronttop']: 
            folder_path = os.path.join('/data/yuantingyu/cube_9_19', folder_name, f'data_{collect_num:03d}') 
    ...
    if contact_points:
        ...
        #设置csv保存的路径
        base_path = f'/data/yuantingyu/cube_9_19'
