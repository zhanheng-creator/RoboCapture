...
args = {
    ...
    "device": "cuda:1",
    #测试改ceshi
    "data_path": "/data/yuantingyu/apple/",
    #测试改ceshi
...
#测试改ceshi
args["resume_from_checkpoint"] = "/data/yuantingyu/apple_test/apple-9-7-(all)-data-400/19-checkpoint.pth"
args["resume"] = True
if args["resume"]:
...
results = []
#测试改ceshi
video_dir = "/data/yuantingyu/apple_test/apple-9-7-(all)-data-400/videos/"
...
#测试改ceshi
excel_path = "/data/yuantingyu/apple_test/apple-9-7-(all)-data-400/(all)-data-400-19pth-results.xlsx"
