...
if __name__ == '__main__':
    ...
    for i in range(2,988):
        ...
        for command3 in command3s:
            ...
            # 实时保存Excel文件
            wb.save("G:\\xjtu\\llm\\project\\command\\output\\output_8_14_command2_dismantle.xlsx")

    # 最终保存Excel文件（可选，因为每次写入后已保存）
    wb.save("G:\\xjtu\\llm\\project\\command\\output\\output_all_8_14_command2_dismantle.xlsx")
